...
public class TencentCOSUpload implements Callable<PartETag> {
	private static Logger logger = LoggerFactory.getLogger(TencentCOSUpload.class);
	 ...
	 *            上传到OSS后的文件名
	 */
	public TencentCOSUpload(File localFile, long startPos, long partSize, int partNumber, String uploadId, String key, boolean isTempFile) {
