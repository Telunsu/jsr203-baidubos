...
public class CosFileAttributes implements BasicFileAttributes {
	...
	private static final Logger logger = LoggerFactory.getLogger(CosFileAttributes.class);
	
	private static final COSClient client = CosInitiator.getClient();
//	private OSSObject ossObject;
	...
	public CosFileAttributes(String key, ObjectMetadata objectMetadata) {
		this.key = key;
		this.objectMetadata = objectMetadata;
	
		if (this.objectMetadata == null) {
			try {
				this.objectMetadata = client.getObjectMetadata(COSConfig.getBucket(), key);
				if (this.objectMetadata != null) {
